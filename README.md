...
Invoke a library API function from the command-line:
    ...
    $ clojure -X tpximpact.clojure-presentation/foo :a 1 :b '"two"'
...
Your library will be deployed to net.clojars.tpximpact/clojure-presentation on clojars.org by default.
